                        ...
                        <div class="card-body">
                            ...
                            <form action="" method="post">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="description" name="description" placeholder="Enter the description" required><?= $reclamation['description']; ?></textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="status" name="status" required>
                                        ...
                                        <option value="pending" <?= ($reclamation['statut'] == 'pending') ? 'selected' : ''; ?> >Pending Request</option>
