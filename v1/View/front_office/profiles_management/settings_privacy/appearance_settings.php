                    ...
                    <div class="container-fluid">
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                ...
                                <p class="mb-2" id="paragraph">If you choose Device settings, this app will use the mode
                                    that’s already selected in this device’s settings.</p><br>
                                <form method="POST">
                                    <div class="form-check mb-3">
                                        <input class="form-check-input" type="radio" name="appearance" id="deviceSettings"
                                            value="deviceSettings" <?php echo ($_SESSION['appearance'] ?? '') === 'deviceSettings' ? 'checked' : ''; ?>>
                                        <label id="subtitle" class="form-check-label" for="deviceSettings">
                                            Device settings
                                        </label>
                                    </div>
                                    <div class="form-check mb-3">
                                        <input class="form-check-input" type="radio" name="appearance" id="darkMode"
                                            value="darkMode" <?php echo ($_SESSION['appearance'] ?? '') === 'darkMode' ? 'checked' : ''; ?>>
                                        <label id="subtitle" class="form-check-label" for="darkMode">
                                            Dark mode
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="appearance" id="lightMode"
                                            value="lightMode" <?php echo ($_SESSION['appearance'] ?? '') === 'lightMode' ? 'checked' : ''; ?>>
                                ...
                                <div class="card-footer">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div>
                                            <p>If you choose Device settings, this app will use the mode that’s already
                                                selected in this device’s settings.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
