              ...
              <div class="card-body">
                ...
                <form method="post" action="../Sign In & Sign Up/signin.php">
                  ...
                  <div class="mb-4 social-container">
                      ...
                      <!-- github -->
                      <button class="social-button github me-4" onclick="window.location.href = '<?php echo $userC->get_github_link(); ?>'; return false;">
                        <svg
                          class="svg"
                          xmlns="http://www.w3.org/2000/svg"
                          x="0px"
                      ...
                      <!-- faceid -->
                      <button class="social-button github" onclick="window.location.href = './../faces_recognation/face recognation.php'; return false;">
                        <svg width="30" height="30" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path d="M7 3H5C3.89543 3 3 3.89543 3 5V7" stroke="#ffffff" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                          <path d="M17 3H19C20.1046 3 21 3.89543 21 5V7" stroke="#ffffff" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                          ...
                          <path d="M7 21H5C3.89543 21 3 20.1046 3 19V17" stroke="#ffffff" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                          <path d="M17 21H19C20.1046 21 21 20.1046 21 19V17" stroke="#ffffff" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
                      </button>
                  </div>
