...
<head>
    <meta charset="UTF-8">
    <title>HireUp Non Moderator Meeting</title>
</head>
...
?>
<body>
    <form id="autoSubmitForm" action="make_a_meeting_link.php?room_name=<?php echo $meeting_data['room_name'] ; ?>" method="POST">
        ...
        <input type="hidden" name="moderator" value="<?php echo 'non moderator';?>">
    </form>
