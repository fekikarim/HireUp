function verif_pub_manaet_inputs(){
    ...
    var image = document.getElementById('image_publication').value;
    ...
    // Validate link
    if (!link) {
        document.getElementById('link_error').innerText = "link is required!";
        return false;
    } else {
    ...
    // Validate image
    if (image === "") {
        document.getElementById('img_error').innerText = "invalid image";
        return false;
    } else {
